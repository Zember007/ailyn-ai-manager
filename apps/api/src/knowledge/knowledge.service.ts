...
const seeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    answerRu: "Программа со стоянкой означает, что на время займа автомобиль размещается на охраняемой парковке компании. Ставка составляет 2,4% в месяц, дополнительно оплачивается парковка 130 сом в сутки; предварительная сумма — до 2 000 000 сом.",
