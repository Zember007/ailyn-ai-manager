...
export const approvedKnowledgeSeeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    category: "documents",
    aliases: ["доверенность", "по доверенности", "займ по доверенности", "доверенность надо", "нужно оформить доверенность", "оформлять доверенность", "доверенность на машину"],
  ...
  },
  {
    ...
    category: "documents",
    aliases: ["нотариальная доверенность на сотрудника", "доверенность на сотрудника", "нотариальная доверенность на автоломбард", "доверенность на автоломбард", "доверенность можно оформить на сотрудника"],
