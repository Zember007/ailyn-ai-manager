...
export const approvedKnowledgeSeeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    answerRu: "Нет, это обязательное условие: для оформления займа автомобиль должен быть зарегистрирован в УНА на человека, который обращается за займом. Сначала нужно поставить автомобиль на учёт в УНА.",
    priority: 100, status: "approved", version: 1, active: true
  },
  {
