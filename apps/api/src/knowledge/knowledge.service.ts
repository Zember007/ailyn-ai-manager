...
export const approvedKnowledgeSeeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    category: "process",
    aliases: ["у братишки машина", "у брата машина", "у друга машина", "у родственника машина", "у него машина", "тоже хотите рассмотреть машину"],
    answerRu: "Да, этот автомобиль тоже можем рассмотреть. Владелец может приехать вместе с Вами или самостоятельно в любое удобное время в часы работы офиса.",
    priority: 100, status: "approved", version: 1, active: true
  },
  {
