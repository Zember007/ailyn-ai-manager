...
export const approvedKnowledgeSeeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    category: "vehicle_eligibility",
    aliases: ["грузовик", "автобус", "спецтехника", "трактор", "экскаватор", "мотоцикл", "скутер", "лодка", "катер", "прицеп"],
    answerRu: "К сожалению, мы принимаем в залог только легковые автомобили. Если у Вас есть легковой автомобиль или минивэн, мы готовы продолжить рассмотрение заявки.",
    priority: 120,
    status: "approved",
    version: 1,
    active: true
