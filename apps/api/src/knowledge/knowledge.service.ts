...
export const approvedKnowledgeSeeds: Omit<KnowledgeItemDto, "id">[] = [
  ...
  },
  {
    ...
    aliases: [
      "действующий договор",
      "текущий договор",
      "сколько я сейчас должен по текущему договору",
      "сколько должен по текущему договору",
      "сколько я должен по текущему займу",
      "остаток по договору",
  ...
  },
  {
    ...
    category: "loan_terms",
    aliases: ["лично приезжать", "нужно присутствие собственника"],
    answerRu: "Да, собственник автомобиля должен лично присутствовать при осмотре автомобиля и выдаче займа.",
    priority: 90,
    status: "approved",
    version: 2,
    active: true
  ...
  },
  {
    ...
    answerRu: "Нет, оформить займ по доверенности нельзя: собственник автомобиля должен лично присутствовать при осмотре и выдаче займа.",
    priority: 100,
    status: "approved",
    version: 3,
    active: true
  ...
  {
    key: "notarial_power_of_attorney_for_company",
    category: "documents",
    aliases: ["доверенность", "доверенность надо", "доверенность нужно делать", "нужно оформить доверенность", "оформлять доверенность", "нотариальная доверенность", "нотариальная доверенность на сотрудника", "доверенность на сотрудника", "нотариальная доверенность на автоломбард", "доверенность на автоломбард", "доверенность можно оформить на сотрудника"],
    answerRu: "Да, оформление нотариальной доверенности может быть одним из условий выдачи займа. Более подробно порядок оформления и условия Вы сможете уточнить во время визита в офис у менеджера.",
    priority: 100,
    status: "approved",
    version: 2,
    active: true
  ...
  },
  {
    ...
    category: "loan_terms",
    aliases:["чем отличается займ без изъятия автомобиля или с постановкой автомобиля на охраняемую стоянку", "чем отличается займ без", "чем отличается без изъятия", "без изъятия автомобиля или с постановкой", "без изъятия или с постановкой автомобиля", "разница программ займа", "сравнить программы займа"],
  ...
  },
  {
    ...
    category: "documents",
    // Старое бытовое название нужно лишь для распознавания входящего текста.
  ...
  },
  {
    ...
    aliases: ["машина после дтп", "автомобиль после дтп", "авто после аварии", "можно на эвакуаторе", "привезти эвакуатором", "машина не на ходу после дтп", "машина не на ходу", "машина после ремонта", "не ездит", "не ездиет"],
  ...
  {
    key: "unsupported_vehicle_type",
    category: "vehicle_eligibility",
    aliases: ["спецтехника", "трактор", "экскаватор", "бульдозер", "погрузчик", "автокран", "комбайн", "грейдер", "асфальтоукладчик"],
    answerRu: "К сожалению, спецтехнику мы не принимаем в залог.",
    priority: 120,
    status: "approved",
    version: 1,
    active: true
  ...
  {
    key: "foreign_vehicle_registration",
    category: "vehicle_eligibility",
    aliases: [
      "авто в рф зарегистрирован",
      "авто в рф зареган",
      "машина зарегистрирована в россии",
      "автомобиль на российских номерах",
      "авто не в кыргызстане зарегистрирован",
      "иностранная регистрация автомобиля"
    ],
    answerRu: "К сожалению, нет. Мы принимаем в залог только автомобили, зарегистрированные в Кыргызской Республике.",
    priority: 120,
    status: "approved",
    version: 1,
    active: true
  },
  {
    ...
    category: "vehicle_eligibility",
    aliases: ["уна", "в уна должна стоять на учете", "в уна должна стоять на учёте", "машина должна быть зарегистрирована в уна", "учет в уна", "учёт в уна", "нет регистрации в уна", "без регистрации в уна", "не зарегистрирован в уна", "не зарегистрирована в уна", "нет учета в уна", "нет учёта в уна", "не стоит на учете в уна", "не стоит на учёте в уна"],
    answerRu: "Для оформления займа автомобиль должен быть зарегистрирован в УНА на человека, который обращается за займом. Это обязательное условие.",
    priority: 100, status: "approved", version: 1, active: true
  },
  {
    key: "another_person_vehicle",
    category: "process",
    aliases: ["у братишки машина", "братишка тоже мой приедет", "братишка тоже приедет", "у брата машина", "машина брата", "у друга машина", "друг тоже хочет займ", "у меня друг тоже хочет займ", "у родственника машина", "у него машина", "рассмотрите еще машину моего брата", "рассмотрите машину брата", "он может приехать вместе со мной", "может приехать со мной", "тоже хотите рассмотреть машину"],
    answerRu: "Да, автомобиль другого собственника тоже можем рассмотреть. Его владелец может приехать вместе с Вами или самостоятельно в любое удобное время в часы работы офиса. Для его автомобиля оформим отдельную заявку.",
    priority: 100, status: "approved", version: 2, active: true
  },
  {
  ...
  },
  {
    ...
    answerRu: "Парковка находится недалеко от нашего офиса и находится под охраной.  Парковка платная — 130 сом в сутки.",
