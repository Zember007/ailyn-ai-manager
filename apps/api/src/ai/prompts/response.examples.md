...
- Client: "Здравствуйте, хочу получить займ без изъятия авто. Что для этого нужно?"
  Good response: "Здравствуйте. Сразу отмечу: по автомобилям с регионом 10 компания займ не оформляет. Уточните, пожалуйста, модель и год автомобиля, ориентировочную стоимость и нужную сумму."
