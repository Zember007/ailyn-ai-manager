...
const chunks: DocumentationChunk[] = [
  ...
  },
  {
    ...
    text: "Программа со стоянкой означает, что на время займа автомобиль размещается на охраняемой парковке компании. Ставка составляет 2,4% в месяц, дополнительно оплачивается парковка 130 сом в сутки. Предварительную сумму рассчитываем по стоимости автомобиля и прописке."
  },
  {
    key: "documents_for_application",
    // «техпаспорт» сохраняем только как входной синоним клиента; в ответах
    // используется утверждённое название «свидетельство о регистрации ТС».
