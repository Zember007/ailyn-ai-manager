...
@Module({
  ...
  providers: [DialogueOrchestratorService, DialogueTurnBatcherService, AgentTurnService, Stage1StoreService, DeferredIntegrationsService],
  exports: [DialogueOrchestratorService, DialogueTurnBatcherService, Stage1StoreService]
})
